package com.mouseLuan.curso.config;
...
import com.mouseLuan.curso.entities.Payment;
import com.mouseLuan.curso.entities.Product;
import com.mouseLuan.curso.entities.User;
import com.mouseLuan.curso.entities.enums.OrderStatus;
import com.mouseLuan.curso.repositories.CategoryRepository;
import com.mouseLuan.curso.repositories.OrderItemRepository;
...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Payment pa1 = new Payment(null, Instant.parse("2019-07-21T21:42:10Z"), o1);
		o1.setPayment(pa1);
